...
module "compute" {
  ...
  static_ip_vault              = module.network.static_ip_vault
  ...
  subnet_vault_self_link       = module.network.subnet_vault_self_link
  tag_fe                       = var.tag_fe
  tag_be                       = var.tag_be
  tag_db                       = var.tag_db
  tag_vault                    = var.tag_vault
  name_fe                      = var.gce_name_fe
  name_be                      = var.gce_name_be
  name_db                      = var.gce_name_db
  name_vault                   = var.gce_name_vault
  machine_type_fe              = var.gce_machine_type_fe
  machine_type_be              = var.gce_machine_type_be
  machine_type_db              = var.gce_machine_type_db
  machine_type_vault           = var.gce_machine_type_vault
  image                        = var.gce_image
  disk_size                    = var.gce_disk_size
  dns_zone_name                = var.dns_zone_name
  dns_record_name              = var.dns_record_name
  startup_fe_image             = var.gce_startup_fe_image
  startup_fe_container_name    = var.gce_startup_fe_container_name
  startup_fe_port              = var.gce_startup_fe_port
  startup_be_image             = var.gce_startup_be_image
  startup_be_container_name    = var.gce_startup_be_container_name
  startup_be_secret_name       = var.gce_startup_be_secret_name
  startup_be_secret_name_json  = var.gce_startup_be_secret_name_json
  startup_be_port              = var.gce_startup_be_port
  startup_db_redis_host        = var.gce_startup_db_redis_host
  startup_db_redis_port        = var.gce_startup_db_redis_port
  startup_vault_image          = var.gce_startup_vault_image
  startup_vault_container_name = var.gce_startup_vault_container_name
  startup_vault_port           = var.gce_startup_vault_port
}
